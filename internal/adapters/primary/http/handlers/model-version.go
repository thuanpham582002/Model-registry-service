...
func (h *Handler) ListModelVersions(c *gin.Context) {
	...
	versions, total, err := h.versionSvc.ListByModel(c.Request.Context(), projectID, modelID, filter)
	if err != nil {
...
func (h *Handler) GetModelVersion(c *gin.Context) {
	...
	version, err := h.versionSvc.GetByModel(c.Request.Context(), projectID, modelID, versionID)
	if err != nil {
		mapDomainError(c, err)
		return
	}
...
func (h *Handler) CreateModelVersion(c *gin.Context) {
	...
	version, err := h.versionSvc.Create(
...
func (h *Handler) UpdateModelVersion(c *gin.Context) {
	...
	version, err := h.versionSvc.Update(c.Request.Context(), projectID, versionID, updates)
	if err != nil {
...
func (h *Handler) FindModelVersion(c *gin.Context) {
	...
	version, err := h.versionSvc.Find(c.Request.Context(), projectID, name, externalID, modelID)
	if err != nil {
		mapDomainError(c, err)
		return
	}
...
func (h *Handler) ListAllModelVersions(c *gin.Context) {
	...
	versions, total, err := h.versionSvc.List(c.Request.Context(), filter)
	if err != nil {
...
func (h *Handler) GetModelVersionDirect(c *gin.Context) {
	...
	version, err := h.versionSvc.Get(c.Request.Context(), projectID, id)
	if err != nil {
		mapDomainError(c, err)
		return
	}
...
func (h *Handler) UpdateModelVersionDirect(c *gin.Context) {
	...
	version, err := h.versionSvc.Update(c.Request.Context(), projectID, id, updates)
	if err != nil {
